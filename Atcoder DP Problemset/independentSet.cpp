...
signed main()
{
    ...
    int dp[n+1][2]; // dp[i][0] = Number of ways to color the subtree rooted at i such that i is colored black, dp[i][1] = Number of ways to color the subtree rooted at i such that i is colored white.
